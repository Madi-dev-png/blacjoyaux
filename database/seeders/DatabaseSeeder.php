...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
       ...
       $products = [
            ...
            // Note : la collection Capsule (Gye Nyame Legacy/Élan/Horizon) existe déjà en base
            // sous ses vrais noms de produit ("Sac Bureau Homme/Femme", "Sac Lifestyle Joyaux"),
            // ajoutés manuellement depuis l'admin — ne pas la re-seeder ici sous d'autres noms,
            // ça créerait des doublons fantômes sans image ni fiche produit réelle.
        ];
